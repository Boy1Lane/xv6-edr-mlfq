...
typedef enum {
  ...
  EDR_REASON_GLOBAL_PRESSURE = 3,  // P2: global PID-pressure limiter
} edr_reason_t;
...
struct proc {
  ...
  int priority;        // Mức ưu tiên (0: Cao nhất, 1: Giữa, 2: Thấp nhất)
  ...
  uint8  is_whitelisted;              // Whitelisted path (init, sh, usertests)
};
