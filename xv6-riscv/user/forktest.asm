...
forktest(void)
{
  ...
  36:	3e650513          	addi	a0,a0,998 # 418 <proc_info+0xe>
  ...
  58:	41450513          	addi	a0,a0,1044 # 468 <proc_info+0x5e>
  ...
  6e:	3be50513          	addi	a0,a0,958 # 428 <proc_info+0x1e>
  ...
  80:	3c450513          	addi	a0,a0,964 # 440 <proc_info+0x36>
  ...
  b0:	3ac50513          	addi	a0,a0,940 # 458 <proc_info+0x4e>
